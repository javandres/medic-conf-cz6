[
  {
    ...
    icon: 'mother-child',
    title: [ { locale:'es', content:'Necesita Visita Prenatal' } ],
    ...
    priority: {
      level: 'high',
      label: [ { locale:'es', content:'Signos de Alarma' } ],
    },
  ...
  // Attach the missing birth schedule to the last scheduled SMS
  {
    ...
    icon: 'mother-child',
    title: [ { locale: 'es', content: 'Falta reporte de nacimiento' } ],
    appliesToForms: [ 'P', 'pregnancy' ],
    ...
    priority: function(c, r) {
      if(isHighRiskPregnancy(c, r)) {
        return {
          level: 'high',
          label: [ { locale:'es', content:'Alto Riesgo' } ],
        };
      }
    },
  ...
  // Be mindful of overflow when peaking ahead!
  {
    ...
    icon: 'pregnancy-1',
    title: [ { locale:'es', content:'No tiene Visita Pre-Natal' } ],
    appliesToForms: [ 'P', 'pregnancy' ],
  ...
  // PNC TASK 1: If a home delivery, needs clinic tasks
  {
    ...
    icon: 'mother-child',
    title: [ { locale:'es', content:'Necesita visita Postnatal' } ],
    ...
    priority: {
      level: 'high',
      label: [ { locale:'es', content:'Nacimiento en Casa' } ],
    },
    resolvedIf: function(c, r, event, dueDate) {
  ...
  // Associate tasks to the last message of each group. Be mindful of overflow when peaking ahead!
  {
    ...
    icon: 'mother-child',
    title: [ { locale:'es', content:'Falta visita Postnatal' } ],
    appliesToForms: [ 'D', 'delivery' ],
  ...
  // Assign task to specific age in months corresponding to the group number
  {
    ...
    icon: 'immunization',
    title: [ { locale:'en', content:'Falta visita de inmunizaciones' } ],
